...
public class DataType {
  ...
  public static final byte[] KEY_HYPERLOGLOG_DATA = "71".getBytes();

  public static final int KEY_BLOOMFILTER = 80;
  public static final byte[] KEY_BLOOMFILTER_DATA = "81".getBytes();

  public static final int KEY_JSONPATH = 90;
  public static final byte[] KEY_JSONPATH_DATA = "91".getBytes();
