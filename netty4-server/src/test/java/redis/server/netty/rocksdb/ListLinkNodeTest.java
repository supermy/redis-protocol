 ...
 * Test data Hash Node.
 */
public class ListLinkNodeTest {
  private static Logger log = Logger.getLogger(ListLinkNodeTest.class);


  @Test
  public  void testListLinkNode() throws RedisException, InterruptedException {
