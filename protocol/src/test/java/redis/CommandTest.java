...
public class CommandTest {
    ...
    public void testNumToBytes() {
        ...
        assertEquals(Longs.fromByteArray(Longs.toByteArray(-12345678)), -12345678);
        assertEquals(Longs.fromByteArray(Longs.toByteArray(-1)), -1);
        assertEquals(Longs.fromByteArray(Longs.toByteArray(0)), 0);
        assertEquals(Longs.fromByteArray(Longs.toByteArray(10)), 10);
        assertEquals(Longs.fromByteArray(Longs.toByteArray(12345678)), 12345678);
